...
The goal when using the augmented matrix is to transform the rows so that the final matrix consists of $0$'s above and below the diagonal of $1$'s on the left of the vertical bar.
