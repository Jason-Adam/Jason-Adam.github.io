...
If we substitute these values back into our original equations, we can see that we've correctly solved the system. At this point I'd like to mention that there are further applications of these two methods, but I will not go into detail regarding them here. 
